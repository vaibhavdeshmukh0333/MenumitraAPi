    ...
    public void viewTemplatesTest(String apiName, String testCaseid, String testType, String description,
        ...
        try {
            ...
            if (apiName.equalsIgnoreCase("viewtemplates")) {
                ...
                // Set payload for view templates request if needed
                if (requestBodyJson.has("outlet_id")) {
                    viewTemplatesRequest.setOutlet_id(requestBodyJson.getInt("outlet_id"));
                }
                
                LogUtils.info("Request Body: " + requestBodyJson.toString());
                ExtentReport.getTest().log(Status.INFO, "Request Body: " + requestBodyJson.toString());
                
                response = ResponseUtil.getResponseWithAuth(baseURI, viewTemplatesRequest, httpsmethod, accessToken);
