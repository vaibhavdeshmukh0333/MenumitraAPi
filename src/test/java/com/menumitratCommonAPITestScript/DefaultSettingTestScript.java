...
public class DefaultSettingTestScript extends APIBase
{
    ...
    @DataProvider(name = "getDefaultSettingsNegativeData")
    public Object[][] getDefaultSettingsNegativeData() throws customException {
        try {
    ...
    @Test(dataProvider = "getDefaultSettingsNegativeData")
    public void defaultSettingsNegativeTest(String apiName, String testCaseid, String testType, String description,
            String httpsmethod, String requestBody, String expectedResponseBody, String statusCode) throws customException {
        try {
            LogUtils.info("Starting default settings negative test case: " + testCaseid);
            ExtentReport.createTest("Default Settings Negative Test - " + testCaseid + ": " + description);
            ExtentReport.getTest().log(Status.INFO, "Test Description: " + description);
            
            if (apiName.equalsIgnoreCase("defaultsettings") && testType.equalsIgnoreCase("negative")) {
                requestBodyJson = new JSONObject(requestBody);
                
                LogUtils.info("Request Body: " + requestBodyJson.toString());
                ExtentReport.getTest().log(Status.INFO, "Request Body: " + requestBodyJson.toString());
                
                // Set payload for default settings request
                ...
                // Validate status code
                    ...
                    LogUtils.success(logger, "Default settings negative test completed successfully");
                    ExtentReport.getTest().log(Status.PASS, MarkupHelper.createLabel("Default settings negative test completed successfully", ExtentColor.GREEN));
                }
            ...
            String errorMsg = "Error in default settings negative test: " + e.getMessage();
